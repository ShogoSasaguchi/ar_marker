...
parser.add_argument("tag_file", type=dir_path, help="The path to the apriltag png you want to convert.")
parser.add_argument("out_file", type=str, help="The path to the SVG output file.")
parser.add_argument(
    "--size",
    type=str,
    required=False,
...
def gen_apriltag_svg(width, height, pixel_array, size):
    ...
    svg_text += (
        f'<svg width="{size}" height="{size}" viewBox="0,0,{width},{height}" xmlns="http://www.w3.org/2000/svg">\n'
    )
